...
<div class="<?php echo esc_attr( $container_class ); ?> training-component"> 
	...
	<?php if ( ! empty( $training_terms ) && ! is_wp_error( $training_terms ) ) : ?>
		<div class="training-filters">
			<button type="button" class="training-filter active" data-category="all"><?php esc_html_e( 'All modules', 'holateam' ); ?></button>
			<?php foreach ( $training_terms as $term ) : ?>
				<button type="button" class="training-filter" data-category="<?php echo esc_attr( $term->slug ); ?>"><?php echo esc_html( $term->name ); ?></button>
			<?php endforeach; ?>
		</div>
	<?php endif; ?>
				...
				<div class="training-card">
					<a href="<?php echo esc_url( $card_link ); ?>">
                        <?php if ( $thumbnail_url ) : ?>
                            <div class="training-card-image" style="background-image:url('<?php echo esc_url( $thumbnail_url ); ?>')"></div>
                        <?php endif; ?>
                    </a>
