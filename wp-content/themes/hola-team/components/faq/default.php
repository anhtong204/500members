<div class="<?php echo $container_class; ?>">
	...
	<?php if (!empty($row['faq_items'])): ?>
		<div class="row <?php echo $faq_image_url ? '' : 'justify-content-center'; ?>">
			<div class="col-md-6 <?php echo $faq_image_url ? 'col-md-6' : 'col-md-8'; ?>">
			...
			<?php if ($faq_image_url): ?>
				<div class="col-md-6 faq-image-col">
					<img class="faq-image" src="<?php echo esc_url($faq_image_url); ?>"
						alt="<?php echo esc_attr($faq_image_alt); ?>" />
				</div>
			<?php endif; ?>
		</div>
	<?php endif; ?>
