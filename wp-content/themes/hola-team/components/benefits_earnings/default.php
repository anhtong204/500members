...
$earnings_note = $row['earnings_note'] ?? esc_html__( 'How we estimate your earnings', 'holateam' );
            ...
            <div class="benefits-earnings-card">
                    ...
                    <div class="earnings-card-select">
                        <select aria-label="<?php echo esc_attr__( 'Select state', 'holateam' ); ?>">
                            <?php foreach ( $select_options as $option ) : ?>
                                <option value="<?php echo esc_attr( $option['id'] ); ?>" data-rate="<?php echo esc_attr( $option['rate'] ); ?>">
                        ...
                        <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.63067 9.75C6.24577 10.4167 5.28352 10.4167 4.89862 9.75L0.135483 1.5C-0.249417 0.833332 0.231709 -1.85702e-07 1.00151 -1.18403e-07L10.5278 7.1441e-07C11.2976 7.81709e-07 11.7787 0.833334 11.3938 1.5L6.63067 9.75Z" fill="currentColor"/>
                        </svg>
                ...
                <div class="earnings-card-body">
                    <div class="earnings-card-control">
                        <label class="earnings-card-label" for="benefits-members-range"><?php echo esc_html( $earnings_label ); ?></label>
                        <div class="earnings-range-wrap">
                            <input id="benefits-members-range" class="benefits-range-input" type="range" min="100" max="500" step="100" value="<?php echo esc_attr( $slider_value ); ?>"
                                data-min-earnings="16000" data-max-earnings="84000" data-interval="<?php echo esc_attr( $earnings_interval ); ?>" />
                    ...
                    <div class="earnings-card-note">
                        <span><?php echo esc_html( $earnings_note ); ?></span>
                        <span class="earnings-note-icon" aria-hidden="true">i</span>
                    </div>
                </div>
            </div>
        </div>
