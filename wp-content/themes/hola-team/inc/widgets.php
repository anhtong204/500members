 ...
 */
add_filter( 'dynamic_sidebar_params', 'holateam_widget_classes' );

if ( ! function_exists( 'holateam_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function holateam_widget_classes( $params ) {
...
} // End of if function_exists( 'holateam_widget_classes' ).

add_action( 'widgets_init', 'holateam_widgets_init' );

if ( ! function_exists( 'holateam_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function holateam_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Footer 1', 'holateam' ),
				'id'            => 'footer-1',
				'description'   => __( 'Footer 1 widget area', 'holateam' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer 2', 'holateam' ),
				'id'            => 'footer-2',
				'description'   => __( 'Footer 2 widget area', 'holateam' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer 3', 'holateam' ),
				'id'            => 'footer-3',
				'description'   => __( 'Footer 3 widget area', 'holateam' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
...
} // endif function_exists( 'holateam_widgets_init' ).
