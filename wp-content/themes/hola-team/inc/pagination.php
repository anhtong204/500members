...
if ( ! function_exists( 'holateam_pagination' ) ) {
	/**
	 ...
	 */
	function holateam_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'holateam' ),
				'next_text'          => __( '&raquo;', 'holateam' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'holateam' ),
				'format'             => 'page/%#%',
