...
if ( ! function_exists( 'holateam_adjust_body_class' ) ) {
	 ...
	 */
	function holateam_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'holateam_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function holateam_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'holateam' ),
		__( 'Previous', 'holateam' ),
		__( 'Next', 'holateam' ),
		__( 'About:', 'holateam' ),
		__( 'Profile', 'holateam' ),
		__( 'Posts by', 'holateam' ),
		__( 'Permanent Link:', 'holateam' ),
		__( 'in', 'holateam' ),
		__( 'Edit', 'holateam' ),
	);
}
